...
| MAJ-002 | **API error contract inconsistent** - crop lookup, planning domain errors, validation errors, and throttling now use the shared contract; future approval/controllers still need coverage | Major | Agent C | Continue contract tests when new approval/controllers are introduced | MVP-0 | 🟡 PARTIAL |
...
| M4 | Mobile log submission | 🟡 | `task-06-farming-log-foundation.md`, `task-06-work-task-log-api.md`, `task-06-smoke-evidence.md`, `mobile-smoke-continuation.md`, `mobile-device-smoke-readiness.md`; device/emulator smoke pending |
