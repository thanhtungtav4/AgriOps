...
- Giá bán và ước lượng doanh thu
- Quản lý giống cây trồng
- Quản lý lứa trồng (lifecycle đầy đủ)
- Báo cáo sau vụ
- Cảnh báo tự động
...
- Không cần module quản lý khách hàng (CRM khách hàng) ở v1.
- Không cần quản lý kho vật tư chi tiết ở v1; chỉ ghi nhận chi phí.
- Không cần quản lý thanh toán/công nợ ở v1.
...
## 6.3. Giống cây trồng (Crop Variety)

Mỗi loại cây trồng có thể có nhiều giống khác nhau. Mỗi giống có đặc tính sản xuất riêng, ảnh hưởng trực tiếp đến định mức, năng suất và kế hoạch trồng.

Thông tin giống cây trồng:

- Tên giống
- Mã giống
- Loại cây trồng (liên kết với cây trồng cha)
- Nguồn giống / nhà cung cấp
- Đặc điểm nổi bật
- Thời gian sinh trưởng trung bình (có thể khác giống khác cùng loại cây)
- Năng suất trung bình (có thể khác giống khác cùng loại cây)
- Mật độ trồng khuyến nghị
- Khả năng kháng bệnh
- Mùa vụ phù hợp
- Vùng khí hậu phù hợp
...
- Khi lập kế hoạch trồng, chọn đến cấp giống (không chỉ loại cây).
- Định mức sản xuất (section 10) được gắn với giống cụ thể. Nếu cùng loại cây mà khác giống thì năng suất, thời gian sinh trưởng, mật độ trồng có thể khác.
- Chuẩn thành phẩm (section 6.2) có thể khác nhau theo giống.
- Chu kỳ sinh trưởng (section 7) có thể tùy chỉnh theo giống.
- Báo cáo năng suất (section 26.2) cần so sánh được giữa các giống cùng loại cây.
- Khi chọn giống cho lứa trồng, hệ thống hiển thị lịch sử năng suất của giống đó tại farm/lô tương tự nếu có dữ liệu.
...
- Giá bán ước lượng và doanh thu dự kiến

---

# 12B. Lứa trồng (Planting Batch)

Lứa trồng là đơn vị trung tâm kết nối kế hoạch sản xuất với thực tế canh tác. Mỗi lứa trồng đại diện cho một đợt gieo/trồng cụ thể của một giống cây trên đất thực tế.

## 12B.1. Thông tin lứa trồng

- Mã lứa trồng (tự sinh hoặc theo quy ước: VD `DL-FA01-2026-001`)
- Kế hoạch sản xuất liên kết
- Hợp đồng/nhu cầu cung ứng liên kết (một lứa có thể phục vụ nhiều hợp đồng)
- Cây trồng
- Giống cây trồng
- Farm
- Ngày bắt đầu làm đất (dự kiến / thực tế)
- Ngày gieo/trồng (dự kiến / thực tế)
- Ngày bắt đầu thu (dự kiến / thực tế)
- Ngày kết thúc (dự kiến / thực tế)
- Số cây dự kiến trồng
- Số cây thực tế trồng
- Số cây sống thực tế
- Tỷ lệ sống thực tế
...
7. Đang sinh trưởng
8. Đang ra hoa (nếu có)
9. Đang nuôi trái / tạo củ / tạo lá thương phẩm (nếu có)
10. Đang thu hoạch
...
Trạng thái lứa trồng tự động cập nhật khi ghi nhận thực tế chuyển giai đoạn sinh trưởng.

## 12B.3. Phân bổ đất cho lứa trồng

Một lứa trồng có thể trải trên nhiều lô đất / nhiều luống. Không hard-code 1 lứa = 1 lô.

Bảng phân bổ (Planting Batch Plot Allocation) cần lưu:

- Lứa trồng
- Farm
- Lô đất
- Luống (nếu quản lý đến luống)
- Diện tích phân bổ (m2)
- Số cây phân bổ
- Trạng thái phân bổ
- Ghi chú

Khi phân bổ đất, hệ thống cần:

- Kiểm tra lô đất có đang trống/sẵn sàng không
- Kiểm tra diện tích còn lại đủ không
- Cảnh báo nếu lô đất vừa trồng cây cùng họ (luân canh)
- Cảnh báo nếu lô đất chưa hết thời gian nghỉ/cải tạo

## 12B.4. Lifecycle lứa trồng

```text
Tạo kế hoạch
→ Duyệt kế hoạch
→ Phân bổ đất (chọn lô/luống)
→ Làm đất
→ Gieo/trồng
→ Chăm sóc cây con
→ Sinh trưởng
→ (Ra hoa → Nuôi trái nếu có)
→ Nghiệm thu trước thu hoạch
→ Thu hoạch (1 lần hoặc nhiều lần)
→ Kết thúc thu hoạch
→ Cải tạo đất
→ Hoàn tất → Báo cáo sau vụ
```

Tại mỗi bước chuyển trạng thái:

- Ghi nhận ngày thực tế (so sánh với ngày dự kiến)
- Ghi nhận người thực hiện
- Cập nhật trạng thái lứa trồng
- Cập nhật trạng thái lô đất liên quan
- Tính chênh lệch ngày thực tế vs kế hoạch

## 12B.5. Liên kết với các module khác

| Module | Quan hệ |
|--------|--------|
| Kế hoạch sản xuất (section 12) | 1 kế hoạch → nhiều lứa trồng |
| Hợp đồng cung ứng (section 11) | Nhiều-nhiều: 1 hợp đồng → nhiều lứa; 1 lứa → nhiều hợp đồng |
| Lô đất / Luống (section 5) | Nhiều-nhiều qua bảng phân bổ |
| Giống cây trồng (section 6.3) | Nhiều lứa → 1 giống |
| Công việc (section 13) | 1 lứa → nhiều công việc |
| Nhật ký sản xuất (section 14) | 1 lứa → nhiều bản ghi nhật ký |
| Lô thu hoạch (section 16) | 1 lứa → nhiều lô thu hoạch |
| Chi phí (section 25) | 1 lứa → nhiều bản ghi chi phí |
| Giá bán (section 25B) | Ước lượng doanh thu theo lứa |
| Báo cáo sau vụ (section 26.6) | 1 lứa → 1 báo cáo đánh giá |

## 12B.6. Quy ước mã lứa trồng

Đề xuất quy ước mã tự sinh:

```text
[Mã cây]-[Mã farm]-[Năm]-[Số thứ tự]

Ví dụ:
DL-FA01-2026-001  → Dưa leo, Farm A01, năm 2026, lứa 001
CC-FB02-2026-003  → Cà chua, Farm B02, năm 2026, lứa 003
```

Mã tự sinh bởi hệ thống, người dùng không cần nhập thủ công.
...
# 25B. Giá bán và ước lượng doanh thu

Hệ thống cần quản lý giá bán để ước lượng doanh thu và lợi nhuận khi lập kế hoạch sản xuất.

## 25B.1. Bảng giá bán

Mỗi loại cây trồng / giống cây trồng cần có bảng giá:

- Cây trồng
- Giống cây trồng (nếu giá khác nhau theo giống)
- Đơn vị bán (kg / trái / bó / thùng)
- Giá bán loại A
- Giá bán loại B
- Giá bán loại C
- Giá bán kênh phụ (chợ, bán lẻ, xử lý phụ phẩm) nếu có
- Ngày áp dụng
- Ngày hết hiệu lực (nếu giá theo mùa)
- Ghi chú

Quy tắc:

- Giá bán là giá tham khảo / ước lượng, dùng để tính doanh thu dự kiến khi lập kế hoạch.
- Giá thực tế có thể khác khi giao hàng, nhưng hệ thống lấy giá từ bảng giá làm mặc định.
- Có thể có nhiều mức giá theo thời điểm (mùa cao điểm / thấp điểm).
- Hàng loại B, C nếu bán được thì tính vào doanh thu phụ.

## 25B.2. Ước lượng doanh thu theo lứa trồng

Khi lập kế hoạch hoặc khi lứa trồng đang chạy, hệ thống tính:

```text
Doanh thu dự kiến
= (Sản lượng loại A × Giá loại A)
+ (Sản lượng loại B × Giá loại B)
+ (Sản lượng loại C × Giá loại C)
```

Các chỉ số cần hiển thị:

- Doanh thu dự kiến / lứa trồng
- Doanh thu dự kiến / tháng
- Chi phí dự kiến / lứa trồng (từ section 25)
- Lợi nhuận gộp dự kiến = Doanh thu − Chi phí
- Biên lợi nhuận dự kiến (%)
- Doanh thu / m2
- Doanh thu / kg thu thô
- So sánh doanh thu dự kiến vs thực tế (sau khi có dữ liệu giao hàng)

## 25B.3. Doanh thu thực tế

Sau khi giao hàng, tính doanh thu thực tế từ:

- Phiếu giao hàng: số lượng khách nhận × giá bán
- Trừ: hàng bị trả × giá bán
- Cộng: doanh thu bán kênh phụ (loại B/C/hàng trả xử lý lại) nếu có

Công thức:

```text
Doanh thu thực tế
= Σ (Số lượng khách nhận × Giá bán tại thời điểm giao)
- Σ (Số lượng trả × Giá bán)
+ Σ (Doanh thu kênh phụ nếu có)
```

## 25B.4. Báo cáo lợi nhuận

Chỉ số lợi nhuận cần tính:

- Lợi nhuận gộp / lứa trồng
- Lợi nhuận gộp / cây trồng
- Lợi nhuận gộp / farm
- Lợi nhuận gộp / tháng
- Biên lợi nhuận (%)
- So sánh lợi nhuận dự kiến vs thực tế
- Cây trồng / giống nào có lợi nhuận cao nhất
- Farm / lô nào có lợi nhuận cao nhất
- Xu hướng lợi nhuận theo thời gian

> Lưu ý: Giá bán và doanh thu ở v1 là ước lượng phục vụ ra quyết định. Không thay thế hệ thống kế toán chính thức.
...
> Nhập số lượng cần giao → hệ thống trả ra kế hoạch trồng, tài nguyên, nhân công, chi phí, doanh thu dự kiến và cảnh báo.

---

# 31. Platform và kiến trúc kỹ thuật

## 31.1. Nền tảng

- **Backend & Web Admin:** Laravel (PHP)
- **Mobile App:** Ứng dụng mobile cho nhân công, kỹ thuật, giao hàng làm việc ngoài đồng
- **Database:** MySQL hoặc PostgreSQL
- **API:** RESTful API (Laravel phục vụ cả web admin và mobile app)

## 31.2. Kiến trúc tổng quan
...
## 31.3. Phân chia chức năng Web vs Mobile

| Chức năng | Web Admin | Mobile App |
|-----------|:---------:|:----------:|
| Quản lý farm, lô đất, luống | ✅ | ❌ |
| Quản lý cây trồng, giống, định mức | ✅ | ❌ |
| Lập kế hoạch sản xuất | ✅ | Xem |
| Tạo/duyệt lứa trồng | ✅ | Xem |
| Giao việc | ✅ | Xem |
| Nhận & báo cáo công việc | Xem | ✅ |
| Ghi nhận nhật ký (tưới, bón, ảnh) | Xem | ✅ |
| Ghi nhận sâu bệnh / phát sinh | ✅ | ✅ |
| Nghiệm thu trước thu hoạch | ✅ | ✅ |
| Ghi nhận thu hoạch | ✅ | ✅ |
| Sơ chế, đóng gói | ✅ | Xem |
| Giao hàng, biên bản giao nhận | ✅ | ✅ |
| Quét/tạo QR | ✅ | ✅ |
| Phê duyệt | ✅ | ✅ |
| Báo cáo, dashboard | ✅ | Tóm tắt |
| Cảnh báo, thông báo | ✅ | ✅ (push) |
| Quản lý người dùng, phân quyền | ✅ | ❌ |
| Quản lý giá bán, chi phí | ✅ | ❌ |

## 31.4. Mobile App — yêu cầu đặc biệt

- **Chụp ảnh trực tiếp** từ camera khi ghi nhận nhật ký, thu hoạch, giao hàng
- **Offline mode:** Nhân công ngoài đồng có thể không có internet ổn định. App cần:
  - Lưu dữ liệu offline (công việc, ảnh, ghi nhận)
  - Đồng bộ tự động khi có mạng
  - Hiển thị rõ trạng thái đồng bộ (đã sync / chờ sync)
- **Push notification:** Nhận cảnh báo, công việc mới, nhắc nhở
- **GPS:** Tùy chọn đính kèm vị trí khi ghi nhận (kiểm chứng thực tế)
- **Giao diện đơn giản:** Nhân công không cần thấy toàn bộ hệ thống, chỉ cần xem việc được giao và báo cáo
- **Quét QR:** Quét mã lô đóng gói khi giao hàng

## 31.5. QR công khai

- QR trỏ đến trang web công khai (không cần app để xem)
- Trang công khai hiển thị thông tin truy xuất theo section 19.2
- Host trên domain riêng hoặc subdomain của hệ thống
- Responsive, tối ưu cho mobile browser
- Không yêu cầu đăng nhập

## 31.6. Lưu trữ ảnh

- Ảnh upload từ mobile và web lưu trên cloud storage (S3 hoặc tương đương)
- Nén ảnh trước khi upload từ mobile để tiết kiệm băng thông
- Mỗi ảnh gắn với entity cụ thể (nhật ký, thu hoạch, giao hàng...)
- Giới hạn dung lượng hợp lý theo loại ghi nhận